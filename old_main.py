...
# Create data loader
dataloader = TorchTimeSeriesDataLoader(X, y, validation_split=validation_split, test_split=test_split, period=period, batch_size=batch_size)
...
# Initialize trainer
trainer = TorchTrainer(model, criterion, optimizer, dataloader, scheduler=scheduler, reduction=reduction)
